...
namespace TAPETES
{
    ...
    { 
        ...
        decimal costomanodeobra = decimal.Parse(txtCostoManoDeObra.Text);
        ...
        decimal Integrantes = (numeroIntegrantes*horasDiseño*costoPorHora)+(costoManoObra);
       ...
       decimal PrecioFinal = totalAserrin+totalPintura+totalFrutosSecos+totalflores+totalalimentos+totalAgua+Integrantes;
